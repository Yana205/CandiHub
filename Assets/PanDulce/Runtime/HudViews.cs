...
namespace PanDulce.Runtime
{
    ...
    public sealed class SignView : GeneratedView
    {
        ...
        protected override void Build()
        {
            ...
            ViewFactory.Rect(t, "RopeLeft", Shapes.White, 51f, 56f, 3f, 24f, Palette.ChipFill, "Furniture", 10);
            ViewFactory.Rect(t, "RopeRight", Shapes.White, 75f, 56f, 3f, 24f, Palette.ChipFill, "Furniture", 10);
            ViewFactory.Panel(t, "Board", 8f, 76f, 118f, 76f, 10, Palette.Hex("#fffaf0"), "Furniture", 11);
            topLine = ViewFactory.Label(t, "TopLabel", "next customer in", 8f, 96f, 118f, 10f,
                                        Palette.Hex("#a58358"), "Furniture", 12,
                                        TextAlignmentOptions.Center, FontStyles.Normal);
            bigLine = ViewFactory.Label(t, "BigLabel", "18s", 8f, 128f, 118f, 30f,
                                        Palette.Crust, "Furniture", 12);
        }
        ...
        public void Sync(ShopState state, int secondsShown)
        {
            ...
            string big = state == ShopState.Closed ? $"{secondsShown}s" : "<3";
