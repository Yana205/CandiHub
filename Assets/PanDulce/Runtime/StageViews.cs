...
namespace PanDulce.Runtime
{
    ...
    public sealed class DisplayCaseView : GeneratedView
    {
        ...
        protected override void Build()
        {
            ...
            ViewFactory.Panel(t, "Glass", 9f, 300f, 412f, 96f, 14,
                              new Color(1f, 1f, 1f, 0.22f), "Case", 0);
            ViewFactory.Rect(t, "Rail", Shapes.White, 9f, 315f, 412f, 2f,
                             new Color(1f, 1f, 1f, 0.75f), "Case", 1);
